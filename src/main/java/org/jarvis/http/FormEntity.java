...
public class FormEntity extends HashMap<String, List<String>> {

    public FormEntity addParam(String paramName, String value) {
        computeIfAbsent(paramName, key -> new ArrayList<>()).add(value);
        return this;
    }

    public FormEntity addParams(QueryParams params) {
